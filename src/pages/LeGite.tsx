...
// 2. iconMap doit être défini AVANT d’être utilisé dans Equipement
const iconMap = {
  Bed,
  Sofa,
  Tv,
...
const LeGite = () => {
  ...
  // 3. Cast de retour de t() pour que TS comprenne
  ...
  const galerie = t('leGite.galerie.photos', { returnObjects: true }) as Photo[];
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {galerie.map((photo: Photo, index: number) => (
              <div
                key={index}
